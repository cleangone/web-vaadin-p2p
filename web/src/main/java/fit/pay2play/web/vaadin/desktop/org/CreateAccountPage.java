package fit.pay2play.web.vaadin.desktop.org;
...
import static xyz.cleangone.data.aws.dynamo.entity.person.BasePerson.FIRST_NAME_FIELD;
import static xyz.cleangone.data.aws.dynamo.entity.person.BasePerson.LAST_NAME_FIELD;
import static xyz.cleangone.data.aws.dynamo.entity.person.User.EMAIL_FIELD;
import static xyz.cleangone.web.vaadin.util.VaadinUtils.createTextButton;
import static xyz.cleangone.web.vaadin.util.VaadinUtils.showError;
