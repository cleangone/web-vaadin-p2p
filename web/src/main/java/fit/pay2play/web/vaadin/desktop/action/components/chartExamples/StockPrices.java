package fit.pay2play.web.vaadin.desktop.action.components.chartExamples;
...
public class StockPrices {
    ...
    private static JsonData readJsonDataFrom(String filename)
    {
        ...
        try
        {
            InputStreamReader reader = new InputStreamReader(StockPrices.class.getClassLoader().getResourceAsStream(filename));
            ObjectMapper mapper = new ObjectMapper();
            jsonData = mapper.readValue(reader, JsonData.class);
        }
        catch (Exception e)
        {
